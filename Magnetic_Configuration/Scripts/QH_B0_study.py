...
#phi_edge = 0.007286 * np.linspace(1,2,9)
phi_edge = np.array([
            0.000728600000000,
            0.001548275000000,
            0.002367950000000,
...
for PHIEDGE in phi_edge:
    input_name = "wout_preciseQH_rescaled_PHIEDGE=" + str(PHIEDGE) + ".nc"
    coordinate_flag = 'toroidal'


    # Read in the plasma equilibrium file
    TEST_DIR = (Path(__file__).parent / "wout_files").resolve()
    ...
    OUT_DIR = 'QH_B_0/QH_output_PHIEDGE=' + str(PHIEDGE) + '/'
    ...
    with open(OUT_DIR + 'B_0_study.txt', 'a') as f:
