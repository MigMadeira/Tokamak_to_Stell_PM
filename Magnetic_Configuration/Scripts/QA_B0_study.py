...
#phi_edge = 0.007286 * np.linspace(0.1, 1.0, 9) 
phi_edge = np.array([  
            0.000728600,
            0.0015482750000000002,
            0.002367950,
            0.003187625,
            0.004007300,
            0.004826975,
            0.0056466500000000005,
            0.006466324999999999,
            0.007286000,
            0.008014600,
            0.008834275,
            0.009653950000000001,
            0.010473625,
            0.011293300000000001,
            0.012112975,
            0.012932649999999999,
            0.013752325,
            0.014572000
])
...
for PHIEDGE in phi_edge:
    input_name = "wout_ISTTOK_final_PHIEDGE=" + str(PHIEDGE) + ".nc"
    ...
    OUT_DIR = 'ISTELL_B_0/ISTELL_output_PHIEDGE=' + str(PHIEDGE) + '/'
    ...
    s_out.set_rc( 1, 0, 0.25)
    s_out.set_zs( 1, 0, 0.25)
    ...
    s_in.set_rc(1, 0, 0.12)
    s_in.set_zs(1, 0, 0.12)
    ...
    kwargs['K'] = 21500 # Number of magnets to place... 50000 for a full run perhaps
