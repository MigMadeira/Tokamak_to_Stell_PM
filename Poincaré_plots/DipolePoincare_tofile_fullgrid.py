...
coilfile = "../Plasma_Accessing_Ports/Data/tol=1mm/biot_savart_initial.json"
famus_filename = "../Plasma_Accessing_Ports/Data/tol=1mm/SIMSOPT_dipole_solution.focus"
dipole_file = "../Plasma_Accessing_Ports/Data/tol=1mm/best_result_m=9984.txt"
...
np.save(OUT_DIR+f"Poincare_data_tol={tol_poincare}_t={tmax_fl}_2cm_diag",Poincare_data)
