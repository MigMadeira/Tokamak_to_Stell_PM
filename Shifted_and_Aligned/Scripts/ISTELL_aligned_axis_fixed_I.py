...
input_name = '../Data/wout_ISTELL_final.nc'
coordinate_flag = 'cartesian'
famus_filename = '../Data/Aligned/ISTELL_1cm_cubes_radial_extent=0505m_aligned_nfp=2_nPhi=4.focus'
...
OUT_DIR = 'ISTELL_aligned_axis/1cm_no_diagnostics_no_quadrupole_fixed_I=72kA/'
